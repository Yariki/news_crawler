    ...
    async def crawl(self, source_id:str, use_delay: bool = True):
        ...
        try:
            ...
            for url_feed in urls:
                ...
                normalized_raw_text = text_normalizer.normalize_text(fetched_article.content_text)
                matched_keywords = detect_keywords(normalized_raw_text.normalization_text, active_keywords)
                ...
                article = Article(
                    ...
                    normilized_text=normalized_raw_text.normalization_text,
                    normalized_text_lower=normalized_raw_text.normalization_text_lower,
                    urls=normalized_raw_text.urls,
                    hashtags=normalized_raw_text.hashtags,
                    mentions=normalized_raw_text.mentions,
                    normalization_version=normalized_raw_text.normalization_version,

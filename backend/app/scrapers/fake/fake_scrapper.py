    ...
    async def discover_urls(self) -> list[UrlFeed]:
        ...
        for i in range(20):  # Generate 20 fake URLs
            urls.append(UrlFeed(
                ...
                content_html=self._fake.paragraph(ext_word_list=self._active_keywords or None),
                content_text=self._fake.paragraph(ext_word_list=self._active_keywords or None),

...
async def test_update_users_same_email(client, create_user, db_session):
...
async def test_update_users_same_username(faker, client, create_user, db_session):
    ...
    # Act
    response = await client.put(f"/admin/users/{user_id}", json=user)

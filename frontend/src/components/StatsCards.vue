...
const cards = computed(() => [
  ...
  { title: 'Enabled sources', value: props.stats?.sources_enabled ?? 0, hint: `of ${props.stats?.sources_total ?? 0} total` },
  { title: 'Alerts', value: props.stats?.alerts_total ?? 0, hint: `${props.stats?.keywords_total ?? 0} active keywords` },
])
</script>
